      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
          ...
          <div className="md:col-span-1">
            ...
            >
              ...
              <div className="text-left">
                <div className="text-white/40 text-[10px] leading-none mb-0.5">Download in de</div>
                <div className="text-white text-xs font-semibold leading-none">App Store</div>
              </div>
            </a>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              {[
                ["/over", "Over ons"],
                ["/blog", "Blog"],
                ["mailto:support@phasr.app", "Contact"],
              ].map(([href, label]) => (
                <li key={href}>
                  <a
                    href={href}
        ...
        <div className="border-t border-white/5 pt-8 flex flex-col sm:flex-row items-center justify-between gap-4">
          <p className="text-white/25 text-xs">
            © {currentYear} Phasr. Alle rechten voorbehouden.
          </p>
          <p className="text-white/25 text-xs">
